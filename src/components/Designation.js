    ...
    <div>
          <ul className="mb-8 mt-3 space-y-3 text-left text-gray-300 dark:text-gray-200">
            ...
            <li className="flex items-start space-x-2">
                ...
                <div className='block'>
                    <div className='flex'>
                        <p className="font-semibold">The LEGION Adviser</p>
                        <span className='ml-5 text-slate-500'>2021 - Present</span>
                    </div>
                    <div className='pl-5'>
                        <ul className="text-gray-400 mb-2">
                            <li>
            ...
            <li className="flex items-start space-x-2">
                ...
                <div className='block'>
                    <div className='flex'>
                        <p className="font-semibold">Capstone Project Member of the Panelist</p>
                        <span className='ml-5 text-slate-500'>2019 - Present</span>
                    </div>
                    <div className='pl-5'>
                        <ul className="text-gray-400 mb-2">
