...
export default function Thrane() {
  return (
    <div>
        ...
        <div className='flex items-center align-middle '>
                    ...
                    <p className='ml-2 uppercase text-sm md:text-base font-medium text-white'>My Responsibilities</p>
         ...
         <ul className="mb-8 mt-3 space-y-3 text-left text-gray-300 dark:text-gray-200">
            <li className="flex items-start space-x-2">
                ...
                <div className='block'>
                    <div className='flex'>
                        <p className="font-semibold text-sm md:text-base">Craft multi page web designs</p>
                    </div>               
                </div>
            </li>
            <li className="flex items-start space-x-2">
                ...
                <div className='block'>
                    <div className='flex'>
                        <p className="font-semibold text-sm md:text-base">Develop websites using company selected development stack</p>
                    </div>               
                </div>
            </li>
            <li className="flex items-start space-x-2">
            ...
            <li className="flex items-start space-x-2">
                ...
                <div className='block'>
                    <div className='flex'>
                        <p className="font-semibold text-sm md:text-base">Design social media ads thumbnail and other related graphic arts</p>
                    </div>               
                </div>
            </li>
            ...
            <li className="flex items-start space-x-2">
                ...
                <div className='block'>
                    <div className='grid grid-cols-1 lg:grid-cols-2 pl-5'>
                        ...
                        <div>
                            <p className="text-gray-400 mb-2 text-sm md:text-base">Development Stack</p>
